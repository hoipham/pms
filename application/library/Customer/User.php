...
class Customer_User extends Customer_Abstract implements Customer_Interface {
    ...
    public static function getInstance() {
        ...
        self::$_instance->_auth->setStorage(new Zend_Auth_Storage_Session('Customer', 'mUser'));
